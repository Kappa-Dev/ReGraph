...
class TestRule(object):
    ...
    def test_inject_remove_node(self):
        ...
        clone_name = rule._clone_rhs_node(3)
    ...
    #     rule = Rule(self.p, self.pattern, self.rhs,
    #                 self.p_lhs, self.p_rhs)
    #     new_name = rule.inject_merge_nodes(1, 4)
    #     assert_graph_eq(rule.lhs, self.pattern)
    #     assert_graph_eq(rule.p, self.p)
    ...
    #     rule = Rule(self.p, self.pattern, self.rhs,
    #                 self.p_lhs, self.p_rhs)
    #     rule.inject_add_node_attrs(1, {'a': 1})
    #     t1 = {'a': {1}}
    #     t2 = {'a': {1, 2}}
    #     t3 = {'a': {1, 2}, 'b': {1}}
    #     normalize_attrs(t1)
    ...
    #     rule.inject_add_node_attrs(4, {'a': 1})
    #     assert(rule.rhs.node['s'] == t1)
    #     rule.inject_add_node_attrs(4, {'a': 2})
    #     assert(rule.rhs.node['s'] == t2)
    #     rule.inject_add_node_attrs(4, {'b': 1})
    ...
    #                 self.p_lhs, self.p_rhs)
    #     rule.inject_add_node_attrs(4, {'a': 2})
    #     rule.inject_remove_node_attrs(4, {'a': 1})
    #     t1 = {'a': set()}
    #     t2 = {'a': set([2])}
    #     normalize_attrs(t1)
    #     normalize_attrs(t2)
    ...
    #     rule = Rule(self.p, self.pattern, self.rhs,
    #                 self.p_lhs, self.p_rhs)
    #     rule.inject_update_node_attrs(4, {'b': 2})
    ...
    #     rule = Rule(self.p, self.pattern, self.rhs,
    #                 self.p_lhs, self.p_rhs)
    #     rule.inject_add_edge_attrs(4, 1, {'amazing': True})
    #     assert_graph_eq(rule.p, self.p)
    #     t = {'amazing': {True}}
    #     normalize_attrs(t)
    ...
    #     rule = Rule(self.p, self.pattern, self.rhs,
    #                 self.p_lhs, self.p_rhs)
    #     rule.inject_remove_edge_attrs(2, 3, {'a': set()})
    #     t1 = {'a': {1}}
    #     normalize_attrs(t1)
    #     assert(rule.p.edge['b']['c'] == t1)
    #     assert(rule.rhs.edge['y']['z'] == t1)
    #     rule.inject_remove_edge_attrs(2, 3, {'a': {1}})
    #     t2 = {'a': set()}
    #     normalize_attrs(t2)
    #     print(t2)
    ...
    #     rule = Rule(self.p, self.pattern, self.rhs,
    #                 self.p_lhs, self.p_rhs)
    #     rule.inject_update_edge_attrs(2, 3, {'b': 1})
